...
const MODALITIES = [
  'CT', 'MR', 'XA', 'US', 'NM', 'PET', 'PT', 'DX', 'CR', 'MG',
  'IO', 'RF', 'SC', 'OT', 'BI', 'SR', 'SEG', 'REG',
];
  ...
  return (
    <Form form={form} layout="vertical">
      ...
      <div style={{ display: 'flex', gap: 12 }}>
        <Form.Item name="patient_birth_date" label="Birth Date" style={{ flex: 1 }}>
      ...
      <div style={{ display: 'flex', gap: 12 }}>
        ...
        <Form.Item name="requested_procedure_id" label="Procedure ID" style={{ flex: 1 }}>
          <Input placeholder="e.g., RP-001" />
        </Form.Item>
      </div>
      <div style={{ display: 'flex', gap: 12 }}>
        <Form.Item name="scheduled_date" label="Scheduled Date" style={{ flex: 1 }}>
          <DatePicker style={{ width: '100%' }} />
        </Form.Item>
        <Form.Item name="scheduled_time" label="Scheduled Time" style={{ flex: 1 }}>
          <TimePicker style={{ width: '100%' }} format="HH:mm" />
        </Form.Item>
      </div>
      <Form.Item name="station_ae_title" label="Station AE Title">
        <Select allowClear placeholder="Select or type AE title" mode="tags" maxCount={1} onChange={() => {}}>
          <Select.Option value="OPENPACS_SCANNER_1">OPENPACS_SCANNER_1</Select.Option>
          <Select.Option value="OPENPACS_SCANNER_2">OPENPACS_SCANNER_2</Select.Option>

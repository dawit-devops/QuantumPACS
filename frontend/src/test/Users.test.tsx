...
const mockUsers = [
  { id: 1, username: 'admin', admin: true, status: 'active', role_id: 1, role_name: 'Administrator', role_slug: 'admin' },
  { id: 2, username: 'tech1', admin: false, status: 'active', role_id: 2, role_name: 'Technologist', role_slug: 'technologist' },
  { id: 3, username: 'dr.jane', admin: false, status: 'active', role_id: 3, role_name: 'Radiologist', role_slug: 'radiologist' },
];
...
describe('Users', () => {
  ...
  it('changes user role when a new role is selected', async () => {
    ...
    const option = screen.getAllByText('Radiologist').find(
      (el) => el.closest('.ant-select-item-option'),
    );

...
const mockProfile = { id: 'u1', username: 'alice', email: 'alice@example.com', role: 'admin', admin: true };
...
describe('Account', () => {
  ...
  it('renders confirm password field', async () => {
    renderWithProviders(<Account />);
    expect(await screen.findByPlaceholderText('Confirm new password')).toBeInTheDocument();
  });

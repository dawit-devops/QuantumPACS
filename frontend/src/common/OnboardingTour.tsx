...
const STEPS = [
  {
    ...
    description: 'Find studies by patient name, ID, or accession number. Use Advanced Search for DICOM tag filtering.',
    targetHint: 'Try typing a patient name in the search bar above.',
  },
  {
    title: 'View & Diagnose',
    icon: <EyeOutlined style={{ fontSize: 28, color: 'var(--color-primary)' }} />,
    description: 'Interact with images using your mouse or keyboard. Press ? for keyboard shortcuts, or use the measurement tools.',
  ...
  },
  {
    ...
    description: 'Share studies securely with referring physicians via expiring links. Control access with granular permissions.',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
          ...
          <Button
            ...
            style={{ color: 'var(--text-muted)', marginTop: -8, marginRight: -8 }}
          />
        </div>
        ...
        <Text style={{ display: 'block', marginTop: 12, lineHeight: 1.6, fontSize: 14, color: 'var(--text-secondary)' }}>
          {current.description}
        </Text>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 24 }}>
          ...
          <Space>
            <Button size="small" type="text" onClick={dismiss} style={{ color: 'var(--text-muted)' }}>
              Skip
            </Button>
            {step > 0 && (
        ...
        <Text style={{ display: 'block', textAlign: 'center', marginTop: 12, fontSize: 11, color: 'var(--text-muted)' }}>

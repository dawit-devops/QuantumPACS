        ...
        items={[
          ...
          },
          {
            ...
            children: (
              <div>
                <Text style={{ display: 'block', marginBottom: 16, color: 'var(--text-secondary)' }}>
                  Press a number key to activate a tool. Press <kbd style={kbdStyle}>1</kbd> to return to Pan.
                </Text>
                <Table
                  dataSource={[
                    { tool: 'Pan', key: '1', desc: 'Default — drag to move the image' },
                    { tool: 'Length', key: '2', desc: 'Measure distance between two points' },
                    { tool: 'Rectangle ROI', key: '3', desc: 'Draw rectangular region of interest' },
                    { tool: 'Ellipse ROI', key: '4', desc: 'Draw elliptical region of interest' },
                    { tool: 'Angle', key: '5', desc: 'Measure angle between two lines' },
                    { tool: 'Arrow Annotate', key: '6', desc: 'Add arrow with text label' },
                    { tool: 'Eraser', key: '7 / E', desc: 'Delete individual annotations' },
                  ]}
                  columns={[
                    { title: 'Tool', dataIndex: 'tool', key: 'tool', width: 140 },
                    { title: 'Key', dataIndex: 'key', key: 'key', width: 100, render: (k: string) => <kbd style={kbdStyle}>{k}</kbd> },

...
import { sanitizeReportHtml } from "../radiologist/sanitizeReportHtml";
import "./report.css";
  ...
  return (
    <div className="rpt">
      <div className="rpt-head">
        <div className="rpt-brand">
          ...
          >
            ...
            <circle cx="20" cy="20" r="10" stroke="#67E8F9" strokeWidth="2" opacity="0.55" />
            <line
              x1="20"
              y1="2"
              x2="20"
      ...
      <div className="rpt-body">
        ...
        <section className="rpt-section">
          ...
          {findings ? (
            <div
              className="rpt-text"
              dangerouslySetInnerHTML={{ __html: sanitizeReportHtml(findings) }}
            />
          ) : (
        ...
        <div className="rpt-impression">
          ...
          {impression ? (
            <div
              className="rpt-text"
              dangerouslySetInnerHTML={{ __html: sanitizeReportHtml(impression) }}
            />
          ) : (
            <p className="rpt-text">
        ...
        {recommendations ? (
          <section className="rpt-section">
            ...
            <div
              className="rpt-text"
              dangerouslySetInnerHTML={{ __html: sanitizeReportHtml(recommendations) }}
            />
          </section>
        ) : null}
        ...
        <div className="rpt-sign">
          ...
          <div className="rpt-sig-meta">
            <div className="rpt-mono">{signedAt ? new Date(signedAt).toLocaleString() : "—"}</div>
            <div>
      ...
      <div className="rpt-foot">
        <p>
          <span className="rpt-phi">CONFIDENTIAL — PROTECTED HEALTH INFORMATION.</span>
          This report is intended solely for the use of the patient and their healthcare providers.
          Unauthorized use or disclosure is prohibited by law. Generated by QuantumPACS for{" "}
          {facility}.
        </p>
      </div>
    </div>
